...
use brucedeity\LaravelPageSpeed\Middleware\PageSpeed;
use brucedeity\LaravelPageSpeed\Middleware\CollapseWhitespace;
...
class ShouldNotProcessResponseTest extends TestCase
{
     ...
     *
     * @var \brucedeity\LaravelPageSpeed\Middleware\PageSpeed
     */
